...
namespace GG2014
{
    ...
    public class User : IUser
    {
        ...
        public User() { }
        public User(string id, string pwd, string _name, string _friends, string _signature, int headIndex, string _groups, string strCreator = "")
        {
            this.UserID = id;
        ...
        private string defaultFriendCatalog = "나의 그룹";
        /// <summary>
        /// 默认好友分组。不能被删除。
        /// </summary>
        public string DefaultFriendCatalog
        {
            get 
            {
                ...
                {
                    this.defaultFriendCatalog = "나의 그룹";
                }
                return "나의 그룹"; 
            }
    ...
    public class Group : IGroup
    {
        ...
        public Group() { }
        public Group(string id, string _name, string _creator ,string _announce ,string _members)
        {
            this.groupID = id;
            this.name = _name;
