...
namespace MultiRemotePC
{
    internal class GlobalResourceManager
    {
        public static void Initialize()
        {
            try
            {
                ...
                for (int i = 0; i < GlobalResourceManager.headImagesGrey.Length; i++)
                {
                    ...
                    GlobalResourceManager.headImagesGrey[i] = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + "Gray\\" + list[i]);
                }
                #endregion
            ...
            {
                MessageBox.Show("시스템 리소스적재오류: " + ee.Message);
            }
        }
        ...
        public static void Initialize(string currentUserID)
        {
        ...
        #region SoftwareName
        private static string softwareName = "SNEED";
        ...
        public static Image GetHeadImage(User user)
        {
            return GlobalResourceManager.GetHeadImage(user, false);
        }

        public static Image GetHeadImageOnline(User user)
        {
        ...
        public static Image GetHeadImage(User user, bool mine)
        {
            if (user.HeadImageIndex >= 0)
            {
